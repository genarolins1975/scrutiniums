...
*Inferência.* A inadimplência subiu em doze meses nos dois segmentos: nas pessoas físicas, +1,15 p.p.; nas pessoas jurídicas, +0,52 p.p.; o que indica que a alta não se restringe a um segmento. Os fatos do pacote indicam pressão no endividamento como causa da inadimplência. Refutaria esta leitura: variação em doze meses igual a zero ou negativa na inadimplência de um dos dois segmentos.
